...
public class string {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("str1 == Auxiliary.str2:      " +
                (str1 == Auxiliary.str2));        			 // true
        System.out.println("str1.equals(Auxiliary.str2): " +
                str1.equals(Auxiliary.str2));				 // true
...
class Auxiliary {
        static String str1 = "You cannot change me!";            // Interned
        static String str2 = new String("You cannot change me!");// Interned
}